...
>>>>>>> 273324541a54389ec5e867e3c564a767b06b6268
        ...
        endToEpilogue: function (modeKey) {
            ...
            this._backgroundLayer.runAction(cc.sequence(cc.delayTime(0.5), cc.callFunc(function () {
                ...
                that._gameOverMenuLayer.setOnRequestAdCallback(function() {
                    that.onRequestAd();
                });
        ...
        // on game over when player chooses to view an incentivized ad
        // should be defined in subclasses for subclass-specific ad interactions
        onRequestAd: function () {
            cc.log("playing a video ad");
            // handle video ad library calls here.
