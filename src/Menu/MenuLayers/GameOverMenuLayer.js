...
////////////////////
        ...
        onExit: function() {
            cc.eventManager.removeCustomListeners("rewardForVideoAd");
        ...
        _initPromoUI: function () {
            ...
            if (promoUseCase != null) {
                ...
                var promoLabel = this.generateLabel(promoStr, NJ.calculateScreenDimensionFromRatio(NJ.uiSizes.sub));
